...
namespace GeekCommerce.CartAPI.Migrations
{
    /// <inheritdoc />
    public partial class AddCartsDataTableOnDb : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    categoryname = table.Column<string>(name: "category_name", type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    imageurl = table.Column<string>(name: "image-url", type: "varchar(300)", maxLength: 300, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
